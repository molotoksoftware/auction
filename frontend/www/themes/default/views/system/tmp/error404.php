...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo Yii::app()->baseUrl; ?>/themes/admin/css/global.css">
        <meta charset="utf-8">
        ...
        <div class="navbar navbar-top navbar-inverse">
            <div class="navbar-inner">
                <div class="container-fluid">
                    <a class="brand" href="<?php echo Yii::app()->createUrl(Yii::app()->getModule('core')->adminUrl); ?>"> <?php echo Yii::t('admin', 'Control Panel'); ?></a>
                ...
                <div class="span8 offset2">
                    <div class="error-box">
                        ...
                        <div style="margin-top: 50px">
                            <a class="btn btn-blue" href="<?php echo Yii::app()->createUrl(Yii::app()->getModule('core')->adminUrl); ?>">
