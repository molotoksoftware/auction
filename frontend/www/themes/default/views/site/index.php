...
<div class="row main_h1">
    <div class="col-xs-12">
    <h1>Ваш выбор
        <small><a href="/auction?filter=oll&sort=numBids.desc">торгуются сейчас</a></small>
        <small><a href="/auction?period=1d">выставленные за сегодня</a></small>
    <small><a href="/auction?filter=oll&sort=viewed.desc">самое популярное</a></small></h1>
    </div>
</div>
...
<div class="row main_h1">
    <div class="col-xs-12">
    <h1>Новости площадки
        <small><a href="<?php echo Yii::app()->createUrl('/news/index'); ?>">читать все</a></small>
    </div>
</div>
