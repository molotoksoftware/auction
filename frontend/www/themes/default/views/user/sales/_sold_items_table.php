...
<h3>История продаж <?= UI::showQuantityTablHdr($count); ?></h3>
...
$this->widget(
    ...
    [
        ...
        'template'      => $template,
        'emptyText'     => 'Проданные лоты отсутствуют',
