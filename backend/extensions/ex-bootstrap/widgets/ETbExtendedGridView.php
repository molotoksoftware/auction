 ...
 */
Yii::import('ex-bootstrap.widgets.ETbGridView');
 ...
 *  - Sortable rows
 */
class ETbExtendedGridView extends ETbGridView {

    public $itemsCssClass = 'dTable responsive dataTable';
    ...
    //theme
    // public $pager=array('class'=>'CLinkPager','maxButtonCount'=>5);
    public $pagerCssClass = 'pagination dataTables_paginate paging_full_numbers';

    /**
     * @var array the configuration for the pager.
     * Defaults to <code>array('class'=>'ext.bootstrap.widgets.TbPager')</code>.
     */
    public $pager = array('class' => 'bootstrap.widgets.TbPager', 'displayFirstAndLast' => false);
