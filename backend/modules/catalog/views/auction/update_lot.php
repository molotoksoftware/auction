...
<div class="control-group">
    <label class="control-label required required" for="Auction_text">Описание <span class="required">*</span></label>
    <div class="controls"><div class="redactor_box">
    <?php
    ...
    <div class="row-fluid">
        ...
        <div class="span4">
            ...
            echo Chtml::dropDownList(
                'Cat3',
                $cat3_id,
                Category::getCategoriesForSelect($cat2_id),
                array(
                    'id' => 'Cat3',
                    'class' => 'span12',
...
<div id="content-options" style="<?= (count($options) > 0) ? 'display: block' : 'display: none'; ?>;">
    <?php
    $this->renderPartial(
        '_options',
        array(
