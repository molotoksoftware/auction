            ...
            <div class="box">
                ...
                <div class="box-content">
                    <div class="padded">
                        ...
                        <div class="alert">
                            Вы можете вывести нижеперечисленные настройки в любом месте сайта. Для этого используйте конструкцию следующего вида:
                            <code>&lt;?=Yii::app()-&gt;params['_params']?&gt;</code>, где <strong>_params</strong> уникальный идентификатор.
                        </div>
