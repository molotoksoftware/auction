...
/**
 * Class ReminderExpiryProCommand
 *
 *
 */
class ReminderExpiryProCommand extends CConsoleCommand
{
    ...
    public function run($args)
    {
        ...
        $items = $this->findCompleted($completed->format('Y-m-d'));
        ...
        foreach ($items as $item) {
             ...
             * @notify
             *
             * послать уведомление о завершении PRO
             */
            $params = array(
