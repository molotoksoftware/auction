...
class ArrayHelper
{
     ...
     * @param string|\Closure|array $key     key name of the array element, an array of keys or property name of the
     ...
     * @throws CException if $array is neither an array nor an object.
     */
     ...
     *
     * @param array                 $array     the array to be sorted. The array will be modified after calling this
     *                                         method.
     ...
     *                                         When sorting by multiple keys with different sorting directions, use an
     ...
     *                                         manual](http://php.net/manual/en/function.sort.php) for more details.
     *                                         When sorting by multiple keys with different sort flags, use an array of
     *                                         sort flags.
     *
     * @throws CException if the $direction or $sortFlag parameters do not have
    ...
    public static function multisort(&$array, $key, $direction = SORT_ASC, $sortFlag = SORT_REGULAR)
    {
        ...
        if (is_scalar($direction)) {
            ...
            throw new CException('The length of $direction parameter must be the same as that of $keys.');
        }
        if (is_scalar($sortFlag)) {
            $sortFlag = array_fill(0, $n, $sortFlag);
        } elseif (count($sortFlag) !== $n) {
            throw new CException('The length of $sortFlag parameter must be the same as that of $keys.');
        }
        $args = [];
