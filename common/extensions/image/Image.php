...
class Image
{
    ...
    public function centeredpreview($width, $height)
    {
        ...
        if ($this->width > $this->height) {
            $res = $this->resize(intval($this->width * $height / $this->height), $height);
        } else {
            $res = $this->resize($width, intval($this->height * $width / $this->width));
        }
    ...
    public function maxWidth($width, $height) {
        if($this->width > $width) {
            return $this->resize($width, intval($this->height * $width / $this->width))->crop($width, intval($this->height * $width / $this->width), 'center');
        }
