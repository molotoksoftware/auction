 ...
 * @since 1.0
 */
class CastomPagination extends CComponent
{
	/**
	...
	public function getCurrentPage($recalculate=true)
	{
		...
		{
			if(isset($this->method[$this->pageVar]))
			{
				$this->_currentPage=(int)$this->method[$this->pageVar]-1;
	...
	public function setCurrentPage($value)
	{
		...
		$this->method[$this->pageVar]=$value+1;
	}
