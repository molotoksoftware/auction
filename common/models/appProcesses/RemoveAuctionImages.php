...
/**
 * Class RemoveAuctionImages
 */
class RemoveAuctionImages
{
    const APP_PROCESS_CODE = 'RemoveAuctionImages';

    const APP_PROCESS_TITLE = 'Remove Deleted Auctions Image files';

    private $fromAuctionId;
    ...
    public function __construct()
    {
        ...
        $this->fromAuctionId = $this->appProcess->data['fromAuctionId'];
     ...
     * @return int
     */
    public function getBeginAuctionId()
    {
